...
const CtaSection = dynamic(() => import('@/components/landing/cta'), { ssr: true });
const DifferentiationTable = dynamic(() => import('@/components/landing/differentiation-table'), { ssr: true });
const RoiCalculator = dynamic(() => import('@/components/landing/roi-calculator'), { ssr: true });
const ProcessOverview = dynamic(() => import('@/components/landing/process-overview'), { ssr: true });
const TechStack = dynamic(() => import('@/components/landing/tech-stack'), { ssr: true });
